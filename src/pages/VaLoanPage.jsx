    ...
    <div className="program-detail">
      ...
      >
        <div className="program-hero-inner">
          ...
          <p>
            No down payment for eligible veterans, active-duty service members,
      ...
      <section className="program-detail-grid section">
        <div className="program-block">
          ...
          <p>
            VA loans are backed by the Department of Veterans Affairs and offer
            favorable terms to those who have served our country. With no
            required down payment, no PMI, and streamlined qualification, VA
            financing helps eligible borrowers buy, build, or refinance with
            confidence.
          </p>
        </div>
        <div className="program-block accent">
          ...
          <ul>
            ...
            <li>
              Limits on closing costs and ability for sellers to contribute.
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="program-detail-grid section">
        <div className="program-block">
          ...
          <p>
            A one-time VA funding fee helps keep the program sustainable. The
            amount depends on service history, loan type, and down payment, and
            can often be financed into the loan. Disabled veterans may be
            eligible for a funding fee waiver.
          </p>
        </div>
        <div className="program-block">
          ...
          <ul>
            ...
            <li>
              VA loans may be reused; entitlement can be restored after payoff.
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="program-cta section">
        ...
        <p>
          We&apos;ll help you confirm eligibility, compare options, and close on
          time so you can take full advantage of your VA benefits.
        </p>
