    ...
    <div className="program-detail">
      ...
      >
        <div className="program-hero-inner">
          ...
          <h1>
            What you need to know before speaking with certified FHA lenders
          </h1>
          <p>
            Flexible financing backed by the Federal Housing Administration to
            help more buyers qualify.
          </p>
      ...
      <section className="program-detail-grid section">
        <div className="program-block">
          ...
          <p>
            ...
            built to expand access to homeownership. With lenient credit, down
            payment, and debt-to-income requirements, FHA options help
            first-time buyers and move-up buyers alike secure financing with
            confidence.
          </p>
        </div>
        <div className="program-block accent">
          ...
          <ul>
            <li>
              You are buying your first home and want a low down payment (as
              little as 3.5%).
            </li>
            <li>
              You need flexibility on credit history while still accessing
              competitive rates.
            </li>
            <li>
              You plan to renovate and want to roll improvement costs into one
              loan.
            </li>
            <li>
              You are purchasing a 1–4 unit primary residence and want
      ...
      <section className="program-detail-grid section">
        <div className="program-block">
          ...
          <p>
            FHA loans allow gift funds, flexible qualifying, and seller credits
            to help with closing costs. Mortgage insurance premiums protect the
            lender, which keeps rates competitive even for borrowers with
            limited credit history. Our team walks you through documentation and
            timelines so you can close smoothly.
          </p>
        </div>
        <div className="program-block">
      ...
      <section className="program-cta section">
        ...
        <p>
          Get pre-qualified for an FHA loan and let&apos;s find the best rate
          and terms for your next home purchase. Our loan specialists are ready
